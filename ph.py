...
Rithesh=phone_Contacts("Rithesh","Kishore","9003085387","RitheshKishore22068@gmail.com","Family","06/04/2007")
Rithesh.open_phcontacts()
Rithesh.firstname_verification()
Rithesh.lastname_verification()
Rithesh.phonenumber_verification()
Rithesh.emailid_verification()
Rithesh.groups_verification()
Rithesh.dob_verification()
